...
export default function FormValidation(){
    const cats = [['100','IT'],['200','Machine'],['300','Chemistry']]
    ...
    const onSubmitForm = (event) =>{
        ...
        for(let f of inputFile.current.files){
            if(f.size > maxSize*1000){
                alert(`ขนาดของแต่ละไฟล์ต้องไม่เกิน ${maxNumFiles} KB`)
                event.preventDefault()
                return
            }
        }
            ...
            <div className="mt-3 mb-5 mx-auto p-3 rounded" style={{width:'400px',background:'#cee'}}>
                ...
                <div className="form-group mb-3">
                    ...
                    <div className="form-group mb-3">
                        ...
                        <input type="date" id="dateAdded" name="dateAdded" className="form-control form-control-sm"></input>
                    </div>
                    <div className="form-group mb-3">
